...
package softnecessary.furgonok.compras.data.network;
...
/**
 * Execute network requests on the network thread. Fetch data from a {@link ServerFunctions} object
 * and expose with {@link #getSubscriptions()}.
 */
