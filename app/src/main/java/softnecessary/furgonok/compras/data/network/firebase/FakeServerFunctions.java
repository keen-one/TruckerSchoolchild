...
public class FakeServerFunctions implements ServerFunctions {
   ...
   * <p>
   * Use this class by observing the subscriptions {@link LiveData}. Fake data will be communicated
  ...
  /**
   * Fetch fake basic content and post results to {@link #basicContent}. This will fail if the user
  ...
  /**
   * Fetch fake premium content and post results to {@link #premiumContent}. This will fail if the
  ...
  /**
   * Create a local record of a subscription that is already owned by someone else. Created when the
   * server returns HTTP 409 CONFLICT after a subscription registration request.
   */
