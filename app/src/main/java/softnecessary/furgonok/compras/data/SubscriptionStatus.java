...
public class SubscriptionStatus {
   ...
   * <p>
   * The server does not return JSON for a subscription that is already owned by a different user,
   * so we need to construct a local record with the basic fields.
   */
