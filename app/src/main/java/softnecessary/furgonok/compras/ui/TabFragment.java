...
import softnecessary.furgonok.Inicio;
import softnecessary.furgonok.PantallaInicial;
import softnecessary.furgonok.R;
import softnecessary.furgonok.databinding.FragmentHomeBinding;
import softnecessary.furgonok.databinding.FragmentPremiumBinding;
import softnecessary.furgonok.databinding.FragmentSettingsBinding;
...
public class TabFragment extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    BillingViewModel billingViewModel = ViewModelProviders.of(requireActivity())
    ...
    switch (section) {
      case PantallaInicial.APP_PAGER_INDEX:
        Inicio inicio = new Inicio();
        return inicio.onCreateView(inflater, container, null);
      case PantallaInicial.HOME_PAGER_INDEX:
        return createHomeView(inflater, container, billingViewModel, subscriptionViewModel);
      case PantallaInicial.PREMIUM_PAGER_INDEX:
        return createPremiumView(inflater, container, billingViewModel, subscriptionViewModel);
      case PantallaInicial.SETTINGS_PAGER_INDEX:
